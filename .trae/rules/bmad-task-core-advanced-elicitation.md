# Advanced Elicitation Task Rule

This rule defines the Advanced Elicitation task workflow.
...
Reference this task with `@task-advanced-elicitation` to execute the defined workflow.
